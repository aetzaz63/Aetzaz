  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-black dark:via-slate-900 dark:to-black"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-400 mb-6 max-w-2xl">
